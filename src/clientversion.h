...
//! These need to be macros, as clientversion.cpp's and gust*-res.rc's voodoo requires it
...
/**
 * gustd-res.rc includes this file, but it cannot cope with real c++ code.
