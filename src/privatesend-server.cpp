...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Gust related functionality
...
/*
    ...
    allow endless transaction that would bloat Gust and make it unusable. To
