...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GustNetwork") type = GustNetwork;
    if(strType == "GustNetworkVariable") type = GustNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GustNetwork) s = "GustNetwork";
    if(type == GustNetworkVariable) s = "GustNetworkVariable";
