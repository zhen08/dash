 ...
 *
 *   // network
 *   CGustNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.gust.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGustNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: GustNetwork
// //   -- signature requirements : Key1(User)
// class CGustNetworkVariable : public CGovernanceObject
// {
// private:
