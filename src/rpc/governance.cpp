...
UniValue gobject(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in gust.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("gust.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafeMode
    /* Gust features */
    { "gust",               "getgovernanceinfo",      &getgovernanceinfo,      true  },
    { "gust",               "getsuperblockbudget",    &getsuperblockbudget,    true  },
    { "gust",               "gobject",                &gobject,                true  },
    { "gust",               "voteraw",                &voteraw,                true  },
