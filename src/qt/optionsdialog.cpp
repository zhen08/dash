    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GUST-light"), QVariant("light"));
    ui->theme->addItem(QString("GUST-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GUST-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GUST-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GUST-traditional"), QVariant("trad"));
