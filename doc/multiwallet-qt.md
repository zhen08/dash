...
Only requiring some minor changes is gust.cpp.
...
Changes to gust.cpp
----------------------
gust.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
