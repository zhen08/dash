...
Gust Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Gust Core, where everyone uses
...
pay attention to for reviewers of Gust Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Gust Core uses tinyformat, which is type safe. Leave them out to avoid confusion
