...
This mechanism has been integrated into Bitcore-Node-Gust which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gustpay/insight-api-gust#web-socket-api](https://github.com/gustpay/insight-api-gust#web-socket-api)
* API: [https://github.com/gustpay/insight-api-gust#instantsend-transactions](https://github.com/gustpay/insight-api-gust#instantsend-transactions)
...
By default, the Gust Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gust Core daemon:
